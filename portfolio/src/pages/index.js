...
import profilePic from "../../public/images/profile/6.png";
          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                ...
                building scalable, user-friendly web applications. Passionate
                about problem-solving, clean code, and delivering
                high-performance solutions in dynamic environments.
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="/DuvinduNishad.pdf"
                  target={"_blank"}
                  className="flex items-center bg-black text-light
                ...
                <Link
                  href="mailto:duvindunishad@gmail.com"
                  target={"_blank"}
