  ...
  return (
    ...
    dark:border-light sm:text-base'>
      <Layout className='py-8 flex items-center justify-between lg:flex-col lg:py-6'>
        ...
        Build with<span className='text-primary dark:text-primaryDark  text-2xl px-1'>&#9825;</span><Link href="https://github.com/duvindunishad" className='underline underline-offset-4' target={"_blank"}>Duvindu (GitHub)</Link>
        </div>
